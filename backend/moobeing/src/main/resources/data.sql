...
(2, '우리은행 주택담보대출', '00', 2, 980000),
(3, '우리은행 주택담보대출', '00', 3, 960000),
(4, '우리은행 주택담보대출', '00', 4, 940000),
(5, '우리은행 주택담보대출', '00', 5, 920000),
(6, '우리은행 주택담보대출', '00', 6, 900000),
(7, '우리은행 주택담보대출', '00', 7, 880000),
(8, '우리은행 주택담보대출', '00', 8, 860000),
(9, '우리은행 주택담보대출', '00', 9, 840000),
(10, '우리은행 주택담보대출', '00', 10, 820000),
(11, '우리은행 주택담보대출', '00', 11, 800000),
(12, '우리은행 주택담보대출', '00', 12, 780000),

-- 신한은행 직장인대출
(13, '신한은행 직장인대출', '00', 1, 2000000),
(14, '신한은행 직장인대출', '00', 2, 1950000),
(15, '신한은행 직장인대출', '00', 3, 1900000),
(16, '신한은행 직장인대출', '00', 4, 1850000),
(17, '신한은행 직장인대출', '00', 5, 1800000),
(18, '신한은행 직장인대출', '00', 6, 1750000),
(19, '신한은행 직장인대출', '00', 7, 1700000),
(20, '신한은행 직장인대출', '00', 8, 1650000),
(21, '신한은행 직장인대출', '00', 9, 1600000),
(22, '신한은행 직장인대출', '00', 10, 1550000),
(23, '신한은행 직장인대출', '00', 11, 1500000),
(24, '신한은행 직장인대출', '00', 12, 1450000),

-- IBK기업은행 중소기업대출
(25, 'IBK기업은행 중소기업대출', '00', 1, 3000000),
(26, 'IBK기업은행 중소기업대출', '00', 2, 2950000),
(27, 'IBK기업은행 중소기업대출', '00', 3, 2900000),
(28, 'IBK기업은행 중소기업대출', '00', 4, 2850000),
(29, 'IBK기업은행 중소기업대출', '00', 5, 2800000),
(30, 'IBK기업은행 중소기업대출', '00', 6, 2750000),
(31, 'IBK기업은행 중소기업대출', '00', 7, 2700000),
(32, 'IBK기업은행 중소기업대출', '00', 8, 2650000),
(33, 'IBK기업은행 중소기업대출', '00', 9, 2600000),
(34, 'IBK기업은행 중소기업대출', '00', 10, 2550000),
(35, 'IBK기업은행 중소기업대출', '00', 11, 2500000),
(36, 'IBK기업은행 중소기업대출', '00', 12, 2450000),

-- KB국민은행 전세자금대출
(37, 'KB국민은행 전세자금대출', '00', 1, 4000000),
(38, 'KB국민은행 전세자금대출', '00', 2, 3900000),
(39, 'KB국민은행 전세자금대출', '00', 3, 3800000),
(40, 'KB국민은행 전세자금대출', '00', 4, 3700000),
(41, 'KB국민은행 전세자금대출', '00', 5, 3600000),
(42, 'KB국민은행 전세자금대출', '00', 6, 3500000),
(43, 'KB국민은행 전세자금대출', '00', 7, 3400000),
(44, 'KB국민은행 전세자금대출', '00', 8, 3300000),
(45, 'KB국민은행 전세자금대출', '00', 9, 3200000),
(46, 'KB국민은행 전세자금대출', '00', 10, 3100000),
(47, 'KB국민은행 전세자금대출', '00', 11, 3000000),
(48, 'KB국민은행 전세자금대출', '00', 12, 2900000),

-- 하나은행 생활안정대출
(49, '하나은행 생활안정대출', '00', 1, 5000000),
(50, '하나은행 생활안정대출', '00', 2, 4850000),
(51, '하나은행 생활안정대출', '00', 3, 4700000),
(52, '하나은행 생활안정대출', '00', 4, 4550000),
(53, '하나은행 생활안정대출', '00', 5, 4400000),
(54, '하나은행 생활안정대출', '00', 6, 4250000),
(55, '하나은행 생활안정대출', '00', 7, 4100000),
(56, '하나은행 생활안정대출', '00', 8, 3950000),
(57, '하나은행 생활안정대출', '00', 9, 3800000),
(58, '하나은행 생활안정대출', '00', 10, 3650000),
(59, '하나은행 생활안정대출', '00', 11, 3500000),
(60, '하나은행 생활안정대출', '00', 12, 3350000);
